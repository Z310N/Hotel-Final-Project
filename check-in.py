...
class HOTEL_MANGMENT_checkin:
    ...
    def __init__(self):
        ...
        def chk_mo():
            while True:
                ...
                if self.h.isdigit() == True and len(self.h) != 0 and len(self.h) == 10:
                    self.MOBILE = self.h
                    self.Text1.insert(INSERT, "Phone No. has been inputed""\n")
                    break
                else:
                    self.Text1.insert(INSERT, "invalid input please input a valid Phone No.""\n")
                break
        ...
        self.Message1.configure(text='''PAGE''')
